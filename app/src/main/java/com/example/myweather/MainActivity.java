...
import com.example.myweather.bean.City;
import com.example.myweather.bean.Province;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //创建的apk 的 用户id 以及 该apk的key
    private String userName = "HE2012021657111310";
    private String key = "de15f9c9b3594080bfde604b46388221";
    /**
     * 请输入该省份的城市
     */
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.search:
                ...
                queryWeather();
                if(ProvinceFlag == 0)
                    Toast.makeText(MainActivity.this,"您的省名输入有误",Toast.LENGTH_SHORT).show();
                if(CityFlag == 0)
                    Toast.makeText(MainActivity.this,"您的市名输入有误",Toast.LENGTH_SHORT).show();
                ProvinceFlag = 0;
                CityFlag = 0;
                break;
        }
